...
# Follower overworld sprites (32x32, 6 frames) — separate from vanilla story NPC pokemon gfx
$(OBJEVENTGFXDIR)/pokemon/overworld/%.4bpp: $(OBJEVENTGFXDIR)/pokemon/overworld/%.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
